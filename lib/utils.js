  ...
  function(shim) {
    ...
    var utils = {
      ...
      merge: function(/*obj1, obj2,....deepCopy*/) {
        ...
        // TODO: This jQuery specific logic should move into the jQuery shim
        ...
        return shim.extend.apply(undefined, args);
      },
      ...
      delegate: function(rules) {
        return function(e, data) {
          ...
          Object.keys(rules).forEach(function(selector) {
            if ((parent = shim.closest(target, selector)).length) {
              data = data || {};
              data.el = shim.unwrap(parent);
